...
export class FavoriteService {
  ...
  async remove(favList: string[], id: string, entity: string) {
  ...
  async addTrack(id: string) {
    await this.findOne(db.tracks, id, 'Track');
  ...
  async removeTrack(id: string) {
    await this.remove(db.favorites.tracks, id, 'Track');
  }

  async addAlbum(id: string) {
    await this.findOne(db.albums, id, 'Album');
  ...
  async removeAlbum(id: string) {
    await this.remove(db.favorites.albums, id, 'Album');
  }

  async addArtist(id: string) {
    await this.findOne(db.artists, id, 'Artist');
  ...
  async removeArtist(id: string) {
    await this.remove(db.favorites.artists, id, 'Artist');
  }
}
